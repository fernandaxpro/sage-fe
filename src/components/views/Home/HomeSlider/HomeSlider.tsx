    ...
    <div className="max-w-standard w-full mx-auto h-[319px] md:h-[638px] relative">
      {isLoading ? (
        ...
        <div className="h-full w-full flex items-center justify-center">
          <p className="text-primary text-lg">No banners available</p>
        </div>
      ) : (
        <>
          ...
          <Button
            isIconOnly
            radius="full"
            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 bg-primary text-white shadow-lg hover:scale-110 transition-transform disabled:opacity-50 w-12 h-12"
          ...
          <Button
            isIconOnly
            radius="full"
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-primary text-white shadow-lg hover:scale-110 transition-transform disabled:opacity-50 w-12 h-12"
